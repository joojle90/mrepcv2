...
import {
    ByproductDetailsPage
}
from '../byproductdetails/byproductdetails';
...
@
Page({
    templateUrl: 'build/pages/byproduct/byproduct.html',
    providers: [MrepcData],
    config: {
        tabbarPlacement: "top"
    }
...
export class ByproductPage {
    ...
    openNavDetailsPage(item){
        this.nav.push(ByproductDetailsPage, { item: item });
    }
}
